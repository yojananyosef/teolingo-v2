...
export const module4: ModuleData = {
  ...
  exercises: [
    ...
    },
    {
      ...
      type: "multiple-choice",
      question:
        "¿Puede el sustantivo en estado constructo (el primero de la cadena) llevar el artículo definido (הַ)?",
    ...
    },
    {
      ...
      type: "multiple-choice",
      question:
        "¿Qué cambio morfológico suele ocurrir en los sustantivos masculinos plurales al pasar al estado constructo?",
    ...
    },
    {
      ...
      options: JSON.stringify(["שְׁלֹשָׁה אֲנָשִׁים", "שָׁלֹשׁ אֲנָשִׁים", "שְׁלֹשָׁה אִישׁ", "שָׁלֹשׁ אִישׁ"]),
