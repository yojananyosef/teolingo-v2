...
export const module7: ModuleData = {
  ...
  exercises: [
    ...
    },
    {
      ...
      type: "multiple-choice",
      question:
        "En un verbo I-Gutural (primer radical gutural) en el Imperfecto Qal, ¿qué cambio vocal ocurre en el prefijo?",
    ...
    },
    {
      ...
      type: "multiple-choice",
      question:
        "Los verbos III-He (tercer radical = He) son especiales. ¿Qué ocurre con la He final en el Perfecto Qal 3ms?",
    ...
    },
    {
      ...
      type: "multiple-choice",
      question:
        "En los verbos III-He, ¿qué ocurre cuando se añaden sufijos de perfecto (como -tī, -tā)?",
    ...
    // --- LECCIÓN 19: Verbos I-Nun y Verbos Ayin-Waw ---
    {
      ...
      type: "multiple-choice",
      question:
        "¿Qué característica especial tienen los verbos I-Nun en el Imperfecto y el Imperativo?",
      correctAnswer:
    ...
    },
    {
      ...
      options: JSON.stringify(["Te amé (yo te amé)", "Él te ama", "Tú me amaste", "Él me amará"]),
