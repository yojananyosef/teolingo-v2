...
async function main() {
  ...
  const israeliProgressBackup = preserveUserProgress
    ? await db.select().from(userIsraeliProgress)
    : [];
  ...
  if (false) {
    ...
    // Lección 0-1b: Escritura de Derecha a Izquierda
    await db.insert(lessons).values({
      id: "lesson-0-1b",
      title: "Alfabeto: De Derecha a Izquierda",
      description: "Unidad 0: Aprende la direccionalidad hebrea y el orden visual del alefato.",
      order: 2,
      xpReward: 25,
    });
    ...
    await db.insert(exercises).values([
      {
        id: "ex-0-1b-1",
        lessonId: "lesson-0-1b",
        type: "multiple-choice",
        question: "¿En qué dirección se lee el hebreo?",
      ...
      },
      {
        ...
        lessonId: "lesson-0-1b",
        type: "multiple-choice",
        question: "¿Dónde comienza visualmente una palabra hebrea en pantalla?",
        correctAnswer: "En el extremo derecho",
        options: JSON.stringify([
      ...
      },
      {
        ...
        lessonId: "lesson-0-1b",
        type: "multiple-choice",
        question: "En la secuencia אבג, ¿qué letra lees primero?",
        correctAnswer: "ג",
        options: JSON.stringify(["א", "ב", "ג", "Depende del contexto"]),
        order: 3,
      },
      {
        id: "ex-0-1b-4",
        lessonId: "lesson-0-1b",
        type: "multiple-choice",
        question: "¿Qué hábito ayuda más al iniciar lectura hebrea?",
        correctAnswer: "Seguir el texto con el dedo desde la derecha",
        options: JSON.stringify([
          "Seguir el texto con el dedo desde la derecha",
          "Leer por sílabas de izquierda a derecha",
          "Ignorar el orden visual",
          "Empezar por la letra central",
        ]),
        order: 4,
      },
    ]);

    // Lección 0-1c: Formas Finales (Sofit)
    await db.insert(lessons).values({
      id: "lesson-0-1c",
      title: "Alfabeto: Cinco Formas Finales",
      description: "Unidad 0: Reconoce ך ם ן ף ץ y cuándo aparecen al final de palabra.",
      order: 3,
      xpReward: 30,
    });
    ...
    await db.insert(exercises).values([
      {
        id: "ex-0-1c-1",
        lessonId: "lesson-0-1c",
        type: "multiple-choice",
        question: "¿Qué letra tiene forma final ך?",
        correctAnswer: "כ",
        options: JSON.stringify(["כ", "מ", "נ", "צ"]),
        order: 1,
      },
      {
        id: "ex-0-1c-2",
        lessonId: "lesson-0-1c",
        type: "multiple-choice",
        question: "¿Cuál es la forma final de מ?",
        correctAnswer: "ם",
        options: JSON.stringify(["ם", "ן", "ף", "ץ"]),
        order: 2,
      },
      {
        id: "ex-0-1c-3",
        lessonId: "lesson-0-1c",
        type: "multiple-choice",
        question: "Las formas finales cambian principalmente...",
        correctAnswer: "La forma gráfica, no la pronunciación base",
        options: JSON.stringify([
          "La forma gráfica, no la pronunciación base",
          "El significado y el sonido radical",
          "Solo la transliteración latina",
          "El orden del alefato",
        ]),
        order: 3,
      },
      {
        ...
        lessonId: "lesson-0-1c",
        type: "multiple-choice",
        question: "¿Dónde aparece una forma sofit?",
        correctAnswer: "Al final de una palabra",
        options: JSON.stringify([
          "Al final de una palabra",
          "Solo al inicio",
          "Solo en palabras propias",
          "En cualquier posición indistintamente",
        ]),
        order: 4,
      },
    ]);

    // Lección 0-1d: Begadkephat y Dagesh Lene
    await db.insert(lessons).values({
      id: "lesson-0-1d",
      title: "Alfabeto: Begadkephat",
      description: "Unidad 0: Distingue pronunciación dura/suave con Dagesh Lene en ב ג ד כ פ ת.",
      order: 4,
      xpReward: 35,
    });
    ...
    await db.insert(exercises).values([
      {
        id: "ex-0-1d-1",
        lessonId: "lesson-0-1d",
        type: "multiple-choice",
        question: "¿Qué marca el Dagesh Lene en una letra Begadkephat?",
        correctAnswer: "Pronunciación dura",
        options: JSON.stringify([
          "Pronunciación dura",
          "Vocal larga obligatoria",
          "Silencio de la consonante",
          "Acento musical",
        ]),
        order: 1,
      },
      {
        ...
        lessonId: "lesson-0-1d",
        type: "multiple-choice",
        question: "¿Cuál conjunto es Begadkephat?",
        correctAnswer: "ב ג ד כ פ ת",
        options: JSON.stringify(["ב ג ד כ פ ת", "א ה ו י ע ר", "מ נ ס צ ק ש", "ט ל ח ז ף ץ"]),
        order: 2,
      },
      {
        id: "ex-0-1d-3",
        lessonId: "lesson-0-1d",
        type: "multiple-choice",
        question: "¿Qué contraste clásico muestra בּ frente a ב?",
        correctAnswer: "b vs v",
        options: JSON.stringify(["b vs v", "k vs q", "t vs s", "m vs n"]),
        order: 3,
      },
      {
        id: "ex-0-1d-4",
        lessonId: "lesson-0-1d",
        type: "multiple-choice",
        question: "Sin Dagesh Lene, la pronunciación suele ser...",
        correctAnswer: "Más suave",
        options: JSON.stringify(["Más suave", "Más larga", "Nasal", "Silente"]),
        order: 4,
      },
    ]);

    // Lección 0-1e: Guturales y Resh
    await db.insert(lessons).values({
      id: "lesson-0-1e",
      title: "Alfabeto: Guturales y ר",
      description: "Unidad 0: Identifica א ה ח ע y el comportamiento especial de ר.",
      order: 5,
      xpReward: 35,
    });
    ...
    await db.insert(exercises).values([
      {
        id: "ex-0-1e-1",
        lessonId: "lesson-0-1e",
        type: "multiple-choice",
        question: "¿Cuáles son las consonantes guturales principales?",
      ...
      },
      {
        ...
        lessonId: "lesson-0-1e",
        type: "multiple-choice",
        question: "Las guturales se asocian con pronunciación...",
        correctAnswer: "En la parte posterior de la garganta",
        options: JSON.stringify([
          "En la parte posterior de la garganta",
          "Solo en los labios",
          "Con vibración dental",
          "Sin salida de aire",
        ]),
        order: 2,
      },
      {
        ...
        lessonId: "lesson-0-1e",
        type: "multiple-choice",
        question: "¿Qué consonante suele tratarse junto a guturales por su comportamiento?",
        correctAnswer: "ר",
        options: JSON.stringify(["ר", "ת", "ס", "ל"]),
        order: 3,
      },
      {
        id: "ex-0-1e-4",
        lessonId: "lesson-0-1e",
        type: "multiple-choice",
        question: "¿Qué afirmación es correcta sobre guturales y dagesh forte?",
        correctAnswer: "Generalmente no toman dagesh forte",
        options: JSON.stringify([
          "Generalmente no toman dagesh forte",
          "Siempre toman dagesh forte",
          "Solo aparece en palabras modernas",
          "No tienen relación con vocales",
        ]),
        order: 4,
      },
    ]);

    // Lección 0-1f: Letras Confundibles y Pronunciación Moderna
    await db.insert(lessons).values({
      id: "lesson-0-1f",
      title: "Alfabeto: Letras Confundibles y Pronunciación Moderna",
      description:
        "Unidad 0: Diferencia letras parecidas y contrasta pronunciación tradicional/moderna.",
      order: 6,
      xpReward: 35,
    });
    ...
    await db.insert(exercises).values([
      {
        id: "ex-0-1f-1",
        lessonId: "lesson-0-1f",
        type: "multiple-choice",
        question: "¿Qué par suele confundirse por forma?",
        correctAnswer: "ב y כ",
        options: JSON.stringify(["ב y כ", "א y ת", "ר y מ", "ש y ל"]),
        order: 1,
      },
      {
        id: "ex-0-1f-2",
        lessonId: "lesson-0-1f",
        type: "multiple-choice",
        question: "¿Qué letras suenan parecido en algunos contextos de aprendizaje inicial?",
        correctAnswer: "ט y ת",
        options: JSON.stringify(["ט y ת", "מ y נ", "ל y ר", "א y ה"]),
        order: 2,
      },
      {
        id: "ex-0-1f-3",
        lessonId: "lesson-0-1f",
        type: "multiple-choice",
        question: "En hebreo moderno, ו se pronuncia normalmente como...",
        correctAnswer: "v",
        options: JSON.stringify(["v", "w", "u", "o"]),
        order: 3,
      },
      {
        id: "ex-0-1f-4",
        lessonId: "lesson-0-1f",
        type: "multiple-choice",
        question: "¿Qué diferencia resume mejor tradicional vs moderno?",
        correctAnswer: "Hay convergencia de varios sonidos en la pronunciación moderna",
        options: JSON.stringify([
          "Hay convergencia de varios sonidos en la pronunciación moderna",
          "No hay diferencias",
          "Solo cambia la escritura, no el sonido",
          "La pronunciación moderna usa más dagesh",
        ]),
        order: 4,
      },
    ]);

    // Lección 0-2: Consonantes con Vocales (Deut 6:5)
    await db.insert(lessons).values({
      id: "lesson-0-2",
      title: "Vocales: Consonantes con Vocales",
      description:
        "Unidad 0: Introducción a vocalización con texto consonantal y texto con niqqud.",
      order: 7,
      xpReward: 35,
    });
    ...
    await db.insert(exercises).values([
      ...
      },
      {
        ...
        options: JSON.stringify([
          "Ambos suenan 'a', pero Kamatz es larga y Pataj es corta",
          "Kamatz suena 'a' y Pataj suena 'e'",
          "Kamatz suena 'o' y Pataj suena 'a'",
      ...
      },
      {
        ...
        options: JSON.stringify([
          "Una vocal ultra-corta o ausencia de vocal",
          "Siempre suena como 'e'",
          "Indica que la letra es muda",
          "Solo se usa al final de palabra",
        ]),
        order: 7,
      },
      {
      ...
      },
      {
        ...
        options: JSON.stringify([
          " ֶ (tres puntos en triángulo)",
          " ֵ (dos puntos horizontales)",
          " ִ (un punto debajo)",
          " ַ (línea horizontal)",
        ]),
        order: 10,
    ...
    // Lección 0-2b: Vowel Charts 1-2 (Largas y Cortas)
    await db.insert(lessons).values({
      id: "lesson-0-2b",
      title: "Vocales: Cuadros de Largas y Cortas",
      description:
        "Unidad 0: Domina la diferencia entre vocales largas y cortas en hebreo bíblico.",
      order: 8,
      xpReward: 40,
    });
    ...
    await db.insert(exercises).values([
      ...
      },
      {
        ...
        options: JSON.stringify([
          "Ambos suenan 'u', pero Shuruq se escribe con ו",
          "Shuruq suena 'o' y Qibbuts suena 'u'",
          "Qibbuts es larga y Shuruq es siempre muda",
      ...
      },
      {
        ...
        options: JSON.stringify([
          "Tiene forma de Kamatz pero suele pronunciarse 'o' corta",
          "Es otra forma de Tsere",
          "Solo aparece al final de palabra",
          "Se usa exclusivamente en nombres propios",
        ]),
        order: 7,
      },
      {
        ...
        options: JSON.stringify([
          "Pataj, Segol, Jirik, Qamets Hatuf, Qibbuts",
          "Kamatz, Tsere, Jolam, Shuruq",
          "Shva, Dagesh, Mappiq",
          "Maqef, Sof Pasuk, Meteg",
        ]),
        order: 8,
      },
    ]);

    // Lección 0-2c: Vowel Chart 3, Shewa y Reducidas
    await db.insert(lessons).values({
      id: "lesson-0-2c",
      title: "Vocales: Reducidas y Shewa",
    ...
    await db.insert(exercises).values([
      {
        ...
        options: JSON.stringify([
          "Un signo especial que puede ser vocal o silente",
          "Una vocal larga de tipo 'a'",
          "Un acento musical",
          "Una consonante final",
        ]),
        order: 1,
      },
      {
      ...
      },
      {
        ...
        options: JSON.stringify([
          "Siempre vocales y nunca silentes",
          "Siempre largas",
          "Solo para finales de palabra",
          "Equivalentes a Sof Pasuk",
        ]),
        order: 6,
      },
      {
        ...
        options: JSON.stringify([
          "Puede representar ausencia de vocal o una vocal muy breve",
          "Siempre suena como 'e' larga",
          "Es una forma alternativa de Tsere",
          "Solo aparece con ו",
        ]),
        order: 7,
      },
      {
        ...
        options: JSON.stringify([
          "especial",
          "idéntico a todas las demás letras",
          "sin relación con las vocales",
          "solo moderno y no bíblico",
        ]),
        order: 8,
      },
    ]);

    // Lección 0-2d: Letras Vocálicas y Escritura Defectiva
    await db.insert(lessons).values({
      id: "lesson-0-2d",
      title: "Vocales: Letras Vocálicas y Escritura Defectiva",
      description:
        "Unidad 0: Usa ה, ו, י como letras vocálicas y distingue escritura plena y defectiva.",
      order: 10,
      xpReward: 45,
    });
    ...
    await db.insert(exercises).values([
      ...
      },
      {
        ...
        options: JSON.stringify([
          "Se omiten algunas letras vocálicas",
          "Se agregan más consonantes fuertes",
          "Desaparecen todos los niqqud",
          "No existe diferencia con la plena",
        ]),
        order: 5,
      },
      {
        ...
        options: JSON.stringify([
          "Jolam Vav (plena) y Jolam simple (defectiva)",
          "Kamatz y Pataj",
          "Tsere y Segol",
          "Shva y Hatef",
        ]),
      ...
      },
      {
        ...
        options: JSON.stringify([
          "Conocimiento previo del patrón vocálico",
          "Sof Pasuk únicamente",
          "Maqef solamente",
          "Orden alfabético",
        ]),
        order: 7,
      },
      {
        ...
        options: JSON.stringify([
          "Aclara la vocalización para el principiante",
          "Elimina todas las consonantes finales",
          "Evita el uso de guturales",
          "Sustituye por completo las consonantes",
        ]),
        order: 8,
      },
    ]);

    // Lección 0-vq: Quiz Integrador de Vocales (Opcional)
    await db.insert(lessons).values({
      id: "lesson-0-vowels-quiz-opt",
      title: "Quiz de Vocales (Opcional)",
      description: "Unidad 0: Autoevaluación opcional de niqqud, shewa y letras vocálicas.",
      order: 11,
      xpReward: 0,
    });
    ...
    await db.insert(exercises).values([
      {
        id: "ex-0-vq-1",
        lessonId: "lesson-0-vowels-quiz-opt",
        type: "multiple-choice",
        question: "¿Cuál combinación resume las vocales largas básicas?",
        correctAnswer: "Kamatz, Tsere, Jolam",
        options: JSON.stringify([
          "Kamatz, Tsere, Jolam",
          "Pataj, Segol, Qibbuts",
          "Shewa, Hatef Pataj, Dagesh",
          "Maqef, Meteg, Sof Pasuk",
        ]),
        order: 1,
      },
      {
        ...
        lessonId: "lesson-0-vowels-quiz-opt",
        type: "multiple-choice",
        question: "¿Cuál grupo corresponde a vocales reducidas (hatef)?",
        correctAnswer: "ֲ ֱ ֳ",
        options: JSON.stringify(["ֲ ֱ ֳ", "ָ ֵ ֹ", "ַ ֶ ִ", "וּ ֹ ְ"]),
        order: 2,
      },
      {
        id: "ex-0-vq-3",
        lessonId: "lesson-0-vowels-quiz-opt",
        type: "multiple-choice",
        question: "¿Cuál afirmación sobre Shewa es correcta?",
        correctAnswer: "Puede ser vocal o silente",
        options: JSON.stringify([
          "Puede ser vocal o silente",
          "Siempre suena como e larga",
      ...
      },
      {
        ...
        lessonId: "lesson-0-vowels-quiz-opt",
        type: "multiple-choice",
        question: "¿Qué letras funcionan con frecuencia como letras vocálicas?",
        correctAnswer: "ה ו י",
        options: JSON.stringify(["ה ו י", "ב ג ד", "מ נ ס", "ש ת ר"]),
        order: 4,
      },
      {
        id: "ex-0-vq-5",
        lessonId: "lesson-0-vowels-quiz-opt",
        type: "multiple-choice",
        question: "En lectura inicial, ¿para qué sirve niqqud completo?",
        correctAnswer: "Para clarificar la vocalización",
        options: JSON.stringify([
          "Para clarificar la vocalización",
          "Para eliminar consonantes",
          "Para reemplazar raíces",
    ...
    await db.insert(exercises).values([
      {
        ...
        options: JSON.stringify([
          "Un punto dentro de una letra que modifica su sonido",
          "Una vocal debajo de una letra",
          "Un signo de puntuación al final",
          "Un acento encima de la letra",
        ]),
        order: 1,
      },
      {
      ...
      },
      {
        ...
        options: JSON.stringify([
          "Kal cambia la pronunciación, Jazaq duplica/intensifica la consonante",
          "Son nombres diferentes para lo mismo",
          "Kal es para vocales y Jazaq para consonantes",
          "Kal aparece al inicio y Jazaq al final",
        ]),
        order: 9,
      },
      {
    ...
    await db.insert(exercises).values([
      {
        ...
        options: JSON.stringify([
          "Un guión que une palabras como unidad",
          "Un punto que marca final de oración",
          "Un acento que indica tono musical",
          "Un signo que separa dos versículos",
        ]),
        order: 1,
      },
      {
        ...
        options: JSON.stringify([
          "Une ambas palabras como una sola unidad",
          "Indica que hay una pausa larga entre ellas",
          "Marca el final del versículo completo",
          "Señala un cambio de tono en la lectura",
        ]),
        order: 2,
      },
      {
        ...
        options: JSON.stringify([
          "El final del versículo, como un punto",
          "Una pausa breve dentro del versículo",
          "El comienzo de un párrafo nuevo",
      ...
      },
      {
        ...
        options: JSON.stringify([
          "La pausa principal que lo divide en dos",
          "El final completo del versículo bíblico",
          "Una vocal que se coloca bajo la letra",
          "Que esa consonante no se pronuncia",
        ]),
        order: 4,
      },
      {
        ...
        options: JSON.stringify([
          "Un acento secundario de pronunciación",
          "Una vocal larga debajo de la letra",
          "Un signo que marca fin de oración",
          "Un separador entre dos párrafos",
        ]),
        order: 5,
      },
      {
      ...
      },
      {
        ...
        options: JSON.stringify([
          "Acentos que marcan melodía y estructura",
          "Las vocales principales del texto hebreo",
          "Las consonantes que van al final",
      ...
      },
      {
        ...
        options: JSON.stringify([
          "־ (guión horizontal elevado)",
          "׃ (dos puntos verticales)",
          " ֑ (triángulo invertido)",
          " ֽ (línea vertical corta)",
        ]),
        order: 8,
      },
      {
        ...
        options: JSON.stringify([
          "Por el Sof Pasuk ( ׃ ) al final",
          "Por una mayúscula en la siguiente",
          "Porque hay un espacio más grande",
          "Por un punto y coma después",
        ]),
        order: 9,
      },
      {
        ...
        options: JSON.stringify([
          "Para leer correctamente cualquier texto",
          "No es necesario, son solo decoración",
          "Solo sirven para la música litúrgica",
          "Son opcionales y poco frecuentes",
        ]),
        order: 10,
      },
    ]);
    ...
    await db.insert(lessons).values({
      id: "lesson-0-5",
      title: "Vocales: Guturales y Preferencias",
      description:
        "Unidad 0: Preferencias vocálicas en guturales, matres lectionis, mappiq y pataj furtivo.",
      order: 13,
      xpReward: 45,
    });
    ...
    await db.insert(exercises).values([
      ...
      },
      {
        ...
        options: JSON.stringify([
          "No aceptan dagesh y afectan las vocales",
          "Son las más fáciles de pronunciar",
          "Solo aparecen al final de una palabra",
          "Siempre son mudas y no se leen",
        ]),
        order: 8,
      },
      // --- Matres lectionis ---
      {
        ...
        options: JSON.stringify([
          "Consonantes que actúan como vocales mudas",
          "Las vocales largas del sistema hebreo",
          "Las cuatro consonantes guturales",
          "Los signos de cantilación bíblica",
        ]),
        order: 9,
      },
      {
      ...
      },
      {
        ...
        options: JSON.stringify([
          "Puede indicar los sonidos 'a', 'e' u 'o'",
          "Siempre suena como 'h'",
          "Solo indica el sonido 'a'",
          "Nunca es mater lectionis",
        ]),
        order: 12,
      },
      // --- Mappiq ---
      {
        ...
        options: JSON.stringify([
          "Punto en ה final: indica consonante plena",
          "Es exactamente lo mismo que el Dagesh",
          "Una vocal que se coloca bajo la letra",
          "Un signo de cantilación del versículo",
        ]),
        order: 13,
      },
      {
        ...
        type: "multiple-choice",
        question:
          "¿Cuál es la diferencia entre הּ (con Mappiq) y ה (sin Mappiq) al final de palabra?",
        correctAnswer: "הּ se pronuncia, ה sin punto es muda",
        options: JSON.stringify([
          "הּ se pronuncia, ה sin punto es muda",
          "Son exactamente iguales en todo",
          "ה sin punto suena más fuerte",
          "Solo es visual, sin efecto sonoro",
        ]),
        order: 14,
      },
      // --- Pataj furtivo ---
      {
        ...
        options: JSON.stringify([
          "Pataj bajo gutural final, se lee ANTES",
          "Una vocal larga debajo de cualquier letra",
          "Un signo que elimina esa consonante",
          "Otro nombre para la vocal Kamatz",
        ]),
        order: 15,
      },
      {
        ...
        options: JSON.stringify([
          "Se lee 'a' ANTES de la ח: ru-aj",
          "Se lee 'a' DESPUÉS de la ח: ru-ja",
          "No se pronuncia",
          "Se lee como 'e'",
        ]),
        order: 16,
      ...
      },
      {
        ...
        options: JSON.stringify([
          "Es la última letra de la palabra (Mem final)",
          "Es la primera letra",
          "Es una vocal",
          "Es una gutural",
        ]),
    ...
    // =============================================
    // UNIT 1: Fundamentos y Alef-Bet (ahora order 15-22)
    // =============================================

    // Lección 1 (ahora order 15)
    await db.insert(lessons).values({
      id: "lesson-1",
    ...
    // Lección 2 (antes order 2, ahora order 16)
    await db.insert(lessons).values({
      id: "lesson-2",
    ...
    // Lección 3 (antes order 3, ahora order 17)
    await db.insert(lessons).values({
      id: "lesson-3",
    ...
    // Lección 9 (antes order 9, ahora order 23)
    await db.insert(lessons).values({
      id: "lesson-9",
    ...
    // Lección 10 (antes order 10, ahora order 24)
    await db.insert(lessons).values({
      id: "lesson-10",
    ...
    // Lección 11 (antes order 11, ahora order 25)
    await db.insert(lessons).values({
      id: "lesson-11",
      title: "Números 1-10",
    ...
    // Lección 12 (antes order 12, ahora order 26)
    await db.insert(lessons).values({
      id: "lesson-12",
    ...
    // Lección 13 (antes order 13, ahora order 27)
    await db.insert(lessons).values({
      id: "lesson-13",
    ...
    // Lección 14 (antes order 14, ahora order 28)
    await db.insert(lessons).values({
      id: "lesson-14",
    ...
    // Lección 15 (antes order 15, ahora order 29)
    await db.insert(lessons).values({
      id: "lesson-15",
    ...
    // Lección 16 (antes order 16, ahora order 30)
    await db.insert(lessons).values({
      id: "lesson-16",
    ...
    // Lección 17 (antes order 17, ahora order 31)
    await db.insert(lessons).values({
      id: "lesson-17",
    ...
    // Lección 18 (antes order 18, ahora order 32)
    await db.insert(lessons).values({
      id: "lesson-18",
    ...
    await db.insert(flashcards).values([
      ...
      },
      {
        ...
        imeMetadata: JSON.stringify({
          gestures:
            "Hacer una diagonal con el brazo derecho y dos pequeños brazos con el izquierdo",
        }),
        order: 3,
      },
    ]);
    ...
    await db.insert(flashcards).values([
      {
        id: "fc-u2-1",
        type: "vocabulary",
        frontContent: JSON.stringify({ text: "[קָרָא:r]" }),
        backContent: JSON.stringify({ meaning: "él llamó", translit: "qara" }),
        order: 201,
      },
      {
        id: "fc-u2-2",
        type: "vocabulary",
        frontContent: JSON.stringify({ text: "[נָתַן:r]" }),
        backContent: JSON.stringify({ meaning: "él dio", translit: "natan" }),
        order: 202,
      },
      {
        id: "fc-u2-3",
        type: "vocabulary",
        frontContent: JSON.stringify({ text: "[רָאָה:r]" }),
        backContent: JSON.stringify({ meaning: "él vio", translit: "raah" }),
        order: 203,
      },
      {
        id: "fc-u2-4",
        type: "vocabulary",
        frontContent: JSON.stringify({ text: "[הָלַךְ:r]" }),
        backContent: JSON.stringify({ meaning: "él fue, caminó", translit: "halak" }),
        order: 204,
      },
      {
        id: "fc-u2-5",
        type: "vocabulary",
        frontContent: JSON.stringify({ text: "[שָׁמַיִם:r]" }),
        backContent: JSON.stringify({ meaning: "cielos", translit: "shamayim" }),
        order: 205,
      },
      {
        id: "fc-u2-6",
        type: "vocabulary",
        frontContent: JSON.stringify({ text: "[דָּבָר:r]" }),
        backContent: JSON.stringify({ meaning: "palabra, cosa", translit: "dabar" }),
        order: 206,
      },
      {
        id: "fc-u2-7",
        type: "vocabulary",
        frontContent: JSON.stringify({ text: "[אִשָּׁה:r]" }),
        backContent: JSON.stringify({ meaning: "mujer, esposa", translit: "ishah" }),
        order: 207,
      },
      {
        id: "fc-u2-8",
        type: "vocabulary",
        frontContent: JSON.stringify({ text: "[לֹא:r]" }),
        backContent: JSON.stringify({ meaning: "no", translit: "lo" }),
        order: 208,
      },
      {
        id: "fc-u2-9",
        type: "vocabulary",
        frontContent: JSON.stringify({ text: "[שְׁמוּאֵל:r]" }),
        backContent: JSON.stringify({ meaning: "Samuel", translit: "shemuel" }),
        order: 209,
      },
      {
        id: "fc-u2-10",
        type: "vocabulary",
        frontContent: JSON.stringify({ text: "[עַם:r]" }),
        backContent: JSON.stringify({ meaning: "un pueblo", translit: "am" }),
        order: 210,
      },
      {
        id: "fc-u2-11",
        type: "vocabulary",
        frontContent: JSON.stringify({ text: "[הָ:p][עָם:r]" }),
        backContent: JSON.stringify({ meaning: "el pueblo", translit: "ha'am" }),
        order: 211,
      },
      {
        id: "fc-u2-12",
        type: "vocabulary",
        frontContent: JSON.stringify({ text: "[יהוה:r]" }),
        backContent: JSON.stringify({ meaning: "Yahvé, el Señor", translit: "Adonai" }),
        order: 212,
      },
  ...
  if (preserveUserProgress) {
    ...
    const existingLessonIds = new Set(
      (await db.select({ id: lessons.id }).from(lessons)).map((l) => l.id),
    );
    ...
    if (safeUserFlashcardProgress.length > 0) {
      await db
        ...
        .values(safeUserFlashcardProgress)
        .onConflictDoNothing();
    }
