...
async function main() {
  ...
  const israeliWords = [
    { id: "ifc-1", text: "[הַ:p][בַּיִת:r]", meaning: "La casa", translit: "ha-bayit" },
    ...
    { id: "ifc-5", text: "[הַ:p][יֶּלֶد:r]", meaning: "El niño", translit: "ha-yeled" },
    { id: "ifc-6", text: "[הַ:p][יַּלְדָּה:r]", meaning: "La niña", translit: "ha-yalda" },
  ...
  await db.insert(israeliSentences).values([
    {
      id: "is-1",
      unitId: "israeli-unit-1",
      hebrewText: "[הָ:p][אִישׁ:r] [בַּ:p][בַּיִת:r]",
      translation: "El hombre está en la casa",
      order: 1,
    },
    {
      id: "is-2",
      unitId: "israeli-unit-1",
      hebrewText: "[הָ:p][אִשָּׁה:r] [בַּ:p][בַּיִת:r]",
      translation: "La mujer está en la casa",
      order: 2,
    },
    {
      id: "is-3",
      unitId: "israeli-unit-1",
      hebrewText: "[הַ:p][יֶּלֶד:r] [אוֹכֵל:r] [הַ:p][לֶּחֶם:r]",
      translation: "El niño come el pan",
      order: 3,
    },
    {
      id: "is-4",
      unitId: "israeli-unit-1",
      hebrewText: "[הַ:p][יַּלְדָּה:r] [שׁוֹתָה:r] [הַ:p][מַּיִם:r]",
      translation: "La niña bebe el agua",
      order: 4,
    },
    {
      id: "is-5",
      unitId: "israeli-unit-1",
      hebrewText: "[הַ:p][מֶּלֶךְ:r] [בַּ:p][בַּיִת:r]",
      translation: "El rey está en la casa",
      order: 5,
    },
  ]);
